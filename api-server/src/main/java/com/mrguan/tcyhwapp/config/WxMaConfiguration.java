...
public class WxMaConfiguration {
    ...
    @Autowired
    private RedisConfiguration.DataJedisProperties dataJedisProperties;
...
//                    WxMaDefaultConfigImpl config = new WxMaRedisConfigImpl(dataJedisProperties.redisPoolFactory());
